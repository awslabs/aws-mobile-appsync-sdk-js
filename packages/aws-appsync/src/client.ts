 ...
 */
import 'setimmediate';
import ApolloClient, { ApolloClientOptions, MutationOptions, FetchPolicy } from 'apollo-client';
...
class AWSAppSyncClient<TCacheShape> extends ApolloClient<TCacheShape> {
    ...
    constructor({
        ...
        const defaultApolloOptions = { query: { fetchPolicy: 'cache-and-network' as FetchPolicy } };
